...
Created on Fri Jan 19 13:03:03 2024

Found 47 results from 2024-01-05 to 2024-01-19
OpenAlex URLS (not including from_created_date or the API key)
- [[https://api.openalex.org/works?filter=concepts.id%3Ahttps%3A//openalex.org/C135473242]]
- [[https://api.openalex.org/works?filter=title-and-abstract.search%3Aoxygen%20evolution]]
** Electrically Assisted Thermochemical Water Splitting Based on Ceria   
:PROPERTIES:
:ID: https://openalex.org/W4390578868
:DOI: https://doi.org/10.2139/ssrn.4683179
:AUTHORS: Jonathan Perry, Alberto de la Calle, Timothy W. Jones, Scott W. Done, Juan M. Coronado, Alicia Bayón
:HOST: No host
:END:

Jonathan Perry, Alberto de la Calle, Timothy W. Jones, Scott W. Done, Juan M. Coronado, Alicia Bayón, No host. None(None)] 2024.
    
[[elisp:(doi-add-bibtex-entry "https://doi.org/10.2139/ssrn.4683179")][Get bibtex entry]] 

- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--referenced-works "https://openalex.org/W4390578868"))][Get references]]
- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--related-works "https://openalex.org/W4390578868"))][Get related work]]
- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--cited-by-works "https://openalex.org/W4390578868"))][Get cited by]]

OpenAlex: https://openalex.org/W4390578868
    
Jonathan Perry, Alberto de la Calle, Timothy W. Jones, Scott W. Done, Juan M. Coronado, Alicia Bayón, No host. https://doi.org/10.2139/ssrn.4683179
    
This work presents the first experimental demonstration of electrically assisted thermochemical cycle for water splitting based on ceria, CeO2. By introducing electrical potential during the thermal reduction step, CeO2 is reduced at temperatures below 1000 °C and then re-oxidizing it with water to produce hydrogen spontaneously without the addition of an electrical potential. Using electricity softens the operating conditions of two-step non-stoichiometric thermochemical water splitting cycles. For the first time, it is demonstrated that CeO2 can be reduced at temperatures between 750 to 950 °C under an oxygen partial pressure of 2 ppm, obtaining an extent of reduction from 0.002 to 0.01 when an electrical potential between 0.75 and 2 V is added. Here we have studied two configurations (pure CeO2 and composite CeO2-YSZ), the effect of the reduction temperature and the applied electrical potential on the degree of non-stoichiometry as well as demonstrating its cyclability and hydrogen production capacity. Furthermore, we have proved that if a dielectric such as YSZ is added to the system, under the same operating conditions, the power consumption decreases by 2 orders of magnitude. This research presents a new type of thermo-electrochemical cycle that could be explored in the future for other materials to ameliorate the temperature conditions of conventional thermochemical cycles.    
...
:PROPERTIES:
:ID: https://openalex.org/W4390586697
:DOI: https://doi.org/10.1016/j.apcatb.2023.123686
:AUTHORS: Lixiang He, Ni Wang, Ming Xiang, Li Zhong, Sridhar Komarneni, Wencheng Hu
:HOST: Applied Catalysis B: Environmental
:END:

Lixiang He, Ni Wang, Ming Xiang, Li Zhong, Sridhar Komarneni, Wencheng Hu, Applied Catalysis B: Environmental. None(None)] 2024.
    
[[elisp:(doi-add-bibtex-entry "https://doi.org/10.1016/j.apcatb.2023.123686")][Get bibtex entry]] 

- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--referenced-works "https://openalex.org/W4390586697"))][Get references]]
- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--related-works "https://openalex.org/W4390586697"))][Get related work]]
- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--cited-by-works "https://openalex.org/W4390586697"))][Get cited by]]

OpenAlex: https://openalex.org/W4390586697
    
Lixiang He, Ni Wang, Ming Xiang, Li Zhong, Sridhar Komarneni, Wencheng Hu, Applied Catalysis B: Environmental. https://doi.org/10.1016/j.apcatb.2023.123686
    
The oxygen evolution reaction (OER) is regarded as a critical component in the water splitting system. Creating vacancies, increasing active surface area, and optimizing electronic structure would improve electrocatalytic performance. Herein, a facile electrochemical reduction method is used to generate sulfur vacancies in nickel iron sulfide (NiFe-S) with a large geometry area of 15×16 cm2, which is synthesized using electrodeposition process assisted with the ion exchange (IOE) method. The X-ray absorption spectroscopies (XAS) are applied for atomic-level structural analysis, verifying that electrochemical desulfurization generates abundant S vacancies. The NiFe-S with abundant sulfur vacancies (NiFe-S-Vs) exhibits a low overpotential (252 mV at 100 mA cm-2), and long stability for 260 h at 500 mA cm-2. More importantly, the NiFe-S-Vs catalyst also delivers a small overpotential (235 mV at 1000 mA cm-2) and high alkaline tolerance (140 h at 500 mA cm-2) in 6 M KOH at 60 °C), implying a potentially significant industrial application prospect. Finally, theory calculation further illustrates the high performance of as-prepared vacancies-rich catalyst.    
...
:PROPERTIES:
:ID: https://openalex.org/W4390590087
:DOI: https://doi.org/10.1016/j.jallcom.2023.173393
:AUTHORS: S. Khatun, Santanu Kumar Pal, Poulomi Roy
:HOST: Journal of Alloys and Compounds
:END:

S. Khatun, Santanu Kumar Pal, Poulomi Roy, Journal of Alloys and Compounds. None(None)] 2024.
    
[[elisp:(doi-add-bibtex-entry "https://doi.org/10.1016/j.jallcom.2023.173393")][Get bibtex entry]] 

- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--referenced-works "https://openalex.org/W4390590087"))][Get references]]
- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--related-works "https://openalex.org/W4390590087"))][Get related work]]
- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--cited-by-works "https://openalex.org/W4390590087"))][Get cited by]]

OpenAlex: https://openalex.org/W4390590087
    
S. Khatun, Santanu Kumar Pal, Poulomi Roy, Journal of Alloys and Compounds. https://doi.org/10.1016/j.jallcom.2023.173393
...
:PROPERTIES:
:ID: https://openalex.org/W4390598699
:DOI: https://doi.org/10.1016/j.est.2023.110345
:AUTHORS: Ruili Song, Ling Guan, Lei Fan, Xianhua Miao, Hui Zhang, Jianchun Cheng, Tong Zhou, Cong Ni, Jian Fan
:HOST: Journal of Energy Storage
:END:

Ruili Song, Ling Guan, Lei Fan, Xianhua Miao, Hui Zhang, Jianchun Cheng, Tong Zhou, Cong Ni, Jian Fan, Journal of Energy Storage. 80(None)] 2024.
    
[[elisp:(doi-add-bibtex-entry "https://doi.org/10.1016/j.est.2023.110345")][Get bibtex entry]] 

- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--referenced-works "https://openalex.org/W4390598699"))][Get references]]
- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--related-works "https://openalex.org/W4390598699"))][Get related work]]
- [[elisp:(progn (xref--push-markers (current-buffer) (point)) (oa--cited-by-works "https://openalex.org/W4390598699"))][Get cited by]]

OpenAlex: https://openalex.org/W4390598699
    
Ruili Song, Ling Guan, Lei Fan, Xianhua Miao, Hui Zhang, Jianchun Cheng, Tong Zhou, Cong Ni, Jian Fan, Journal of Energy Storage. https://doi.org/10.1016/j.est.2023.110345
